    ...
    return (
        <Tabs>
            <div className='container px-6 py-10 mx-auto'>
                <h1 className='text-2xl font-semiibold text-center  text-gray-800 lg:text-3xl'>Browse Jobs by Catagories</h1>
                <p className='max-w-2xl mx-auto my-6 text-center'>
                    Three categories  are available on the time being. They are Web Development, Graphics Designning & Digitale-marketing. Browse them by clicking on the tab below.
                </p>
