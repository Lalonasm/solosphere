...
const JobDetails = () => {
  ...
  const { _id, job_title, category, min_price, max_price, description, buyer, deadline } = job || {};
  ...
  const handleFormSubmission = async (e) => {
    ...
    if (price < parseFloat(min_price)) return toast.error('Offer more or atleast equal to minimum price  ')
